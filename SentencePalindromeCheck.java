...
public class SentencePalindromeCheck {
	...
	public static void main(String[] args) {
		...
		//String leks="absc 4321 &^%$$,,,, Lakeside";
		//leks=leks.replaceAll("[^a-zA-Z0-9]", "");
	   ...
	   public static List<List<Integer>> palindromePairs(String[] words) {
		    ...
		    for(int i=0; i<words.length; i++){
		        ...
		        for(int k=1; k<s.length(); k++){
		            ...
		            //e.g for sssll if we split at a point into ss and sll, ss is a palindrome and if we reverse sll it becomes lls and when we find it in the map we add both indices to the list
